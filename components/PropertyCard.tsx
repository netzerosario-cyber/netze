      ...
      <div className="px-2.5 pt-2 pb-2.5 md:p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-1.5 mt-auto min-w-0">
          ...
          <a
            ...
            className="w-9 h-9 md:w-auto md:h-auto md:flex-1 flex items-center justify-center gap-1.5 md:py-2.5 rounded-xl bg-[#25D366] hover:bg-[#1ebe5d] active:scale-[0.98] text-white text-[12px] font-semibold transition-all shadow-sm shrink-0"
          >
