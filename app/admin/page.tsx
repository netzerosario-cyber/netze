    ...
    <div className="max-w-4xl">
      ...
      {isMock && (
        <div className="mb-6 flex items-center gap-2 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 text-amber-700 dark:text-amber-400 text-sm px-4 py-3 rounded-xl">
          ...
          <Link href="/admin/configuracion" className="ml-auto text-amber-700 dark:text-amber-400 font-semibold underline text-xs">Configurar →</Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {cards.map((card) => (
          <Link key={card.label} href={card.href} className="group bg-white dark:bg-[#161b22] rounded-2xl border border-gray-100 dark:border-[#30363d] p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
      ...
      <div className="bg-white dark:bg-[#161b22] rounded-2xl border border-gray-100 dark:border-[#30363d] p-5">
        <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Estado del sistema</h3>
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
        <Link href="/admin/propiedades" className="flex items-center gap-3 bg-white dark:bg-[#161b22] border border-gray-100 dark:border-[#30363d] rounded-xl px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:border-[#0041CE] dark:hover:border-[#0061FB] hover:text-[#0041CE] dark:hover:text-[#0061FB] transition-colors group">
          <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} className="text-gray-400 group-hover:text-[#0041CE] dark:group-hover:text-[#0061FB] transition-colors">
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
          </svg>
          Ver todas las propiedades →
        </Link>
        <Link href="/admin/configuracion" className="flex items-center gap-3 bg-white dark:bg-[#161b22] border border-gray-100 dark:border-[#30363d] rounded-xl px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:border-[#0041CE] dark:hover:border-[#0061FB] hover:text-[#0041CE] dark:hover:text-[#0061FB] transition-colors group">
          <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} className="text-gray-400 group-hover:text-[#0041CE] dark:group-hover:text-[#0061FB] transition-colors">
